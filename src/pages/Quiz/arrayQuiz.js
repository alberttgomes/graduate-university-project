...
const perguntas = [
  {
    ...
    titulo:
      "1) Nesse caso, como você identifica o ato de Carla e demais colegas sobre a foto ?",
    letraA:
      "a) É uma brincadeira de criança e adolescente que o adulto não deve interferir.",
    letraB:
      "b) Não é uma exposição da menina por se tratar de um grupo fechado de amigos.",
    letraC:
    ...
    },
  {
    caso: "Caso 01: Carla, adolescente de 14 anos, conseguiu tirar uma foto de Alyne, colega de sala, sem que ela soubesse. Além disso, Carla utilizou aplicativos de edição de fotos e fez algumas alterações na imagem para divulgar no grupo de Whatsapp de seus colegas mais próximos. Colocou figuras e fez alterações que Alyne não autorizou e que também a ridicularizavam. Assim que a foto foi postada no grupo, quase todos se divertiram bastante, cada um colocou um apelido em razão das características que foram montadas na foto. Porém, um desses componentes do grupo não concordou com a atitude de Carla e nem com as “brincadeiras” dos demais colegas. Assim, ele procurou Alyne, que estava sendo ridicularizada, para informar sobre o ocorrido. ",
    titulo:
      "2) Nesse caso, quais são as consequências judiciais dos atos de Carla e demais colegas ?",
    letraA:
      "a) Carla e os colegas poderão responder a um processo judicial e receber as medidas judiciais cabíveis, como, por exemplo, obrigação de reparar o dano causado à Alyne.",
    letraB: "b) Carla e os colegas não sofrerão consequências.",
    letraC:
  ...
  },
  {
    caso: "Caso 01: Carla, adolescente de 14 anos, conseguiu tirar uma foto de Alyne, colega de sala, sem que ela soubesse. Além disso, Carla utilizou aplicativos de edição de fotos e fez algumas alterações na imagem para divulgar no grupo de Whatsapp de seus colegas mais próximos. Colocou figuras e fez alterações que Alyne não autorizou e que também a ridicularizavam. Assim que a foto foi postada no grupo, quase todos se divertiram bastante, cada um colocou um apelido em razão das características que foram montadas na foto. Porém, um desses componentes do grupo não concordou com a atitude de Carla e nem com as “brincadeiras” dos demais colegas. Assim, ele procurou Alyne, que estava sendo ridicularizada, para informar sobre o ocorrido. ",
    titulo:
      "3) Qual é a recomendação indicada à Alyne após ter conhecimento que sua foto estava sendo ridicularizada ?",
    letraA:
      "a) Responder para as pessoas que estão cometendo cyberbullying que elas são monstros.",
    letraB:
      "b)  Alyne deve marcar um encontro para brigar com Carla, pois isso não pode ficar barato.",
    letraC:
  ...
  },
  {
    ...
    titulo: "4) Sobre a atitude de Mário, o que você acha ?",
    letraA:
      "a) Mário pode divulgar todas as fotos em qualquer lugar da Internet, afinal de contas o celular é dele.",
    letraB:
      "b) Mário teve uma conduta de raiva justificável pelo fim do namoro.",
    letraC:
  ...
  {
    caso: "Caso 02: Mário foi namorado de Joana por 1 ano. Um casal de adolescentes ainda hoje. Estudam na mesma escola e têm vários amigos em comum. Mário nunca ficou satisfeito com o fim do relacionamento e decidiu se vingar de Joana. Criou um perfil falso no Instagram e utilizou para divulgar todas as fotos que ele tinha de Joana no celular. Eram fotos de todos os tipos, inclusive fotos íntimas. As fotos foram tiradas na época em que eles estavam namorando, porém, não foram apagadas e Mário se aproveitou disso.",
    titulo: "6) Diante da dor sofrida por Joana, o que ela pode fazer?",
    letraA:
      "a) Conversar com os pais e/ou responsáveis esclarecendo a sua dor para, então, buscar acompanhamento psicológico.",
    letraB:
      "b) Cancelar a rede social para evitar esse tipo de problema, pois ela se expõe bastante e esse foi o verdadeiro motivo do problema.",
  ...
  },
  {
    ...
    titulo: "7) João está correto?",
    letraA:
      "a) Sim! Somente as pessoas maiores de idade podem ser enquadradas no Código Penal.",
    letraB:
      "b) Não! Pessoas menores de idade podem ser enquadradas no Código Penal.",
    letraC:
  ...
  },
  {
    ...
    titulo: "8) José não está sabendo o que fazer, o que você orientaria:",
    letraA: "a) Eu diria que faz parte, todo mundo já passou por isso.",
    letraB:
      "b) Eu o aconselharia a informar à mãe, ao pai ou ao seu responsável para que um adulto tome as medidas cabíveis, inclusive judiciais.",
  ...
  },
  {
    ...
    titulo: "9) Em qual dessas situações você visualiza cyberbullying?",
    letraA:
      "a) Comentar desaprovando o namoro e desejando infelicidade aos dois",
    letraB:
      "b) Publicar foto da época do namoro deles e dizer que eram muito melhores.",
    letraC: "c) Criar um perfil no Youtube para fazer o mesmo e dar o troco.",
    letraD:
  ...
  },
  {
    ...
    titulo: "10) O que é cyberbullying?",
    letraA:
      "a) É manipular psicologicamente pessoas para executar ações na Internet.",
    letraB: "b) É expor publicamente dados pessoais de usuários da Internet.",
    letraC:
