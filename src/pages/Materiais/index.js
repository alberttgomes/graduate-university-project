...
import blackMaterial from "../../assets/blackMaterial.png";
...
export const data = [
  ...
  },
  {
    title1: "ARTIGOS CIENTIFICOS",
    author:
      "Carlos Evangelioa, Pablo Rodríguez-González, Javier Fernández-Río , Sixto Gonzalez-Villora",
    datenews: new Date(),
    title:
      "Cyberbullying em alunos do ensino fundamental e médio: uma revisão sistemática",
    image: cyberbullimg,
  ...
  },
  {
    ...
    datenews: new Date(),
    title:
      "Afinal, não é tão engraçado! Humor, pais, colegas e sua ligação com experiências de cyberbullying",
    image: cyberbullimg,
  ...
  },
  {
    ...
    datenews: new Date(),
    title:
      "A eficácia das intervenções educativas sobre bullying tradicional e cyberbullying entre adolescentes: uma revisão sistemática e meta-análise",
    image: cyberbullimg,
  ...
  },
  {
    ...
    datenews: new Date(),
    title:
      "CYBERBULLYING: PRÁTICAS E CONSEQUÊNCIAS DA VIOLÊNCIA VIRTUAL NA ESCOLA (2019)",
    image: capaLivro5,
  ...
  },
  {
    ...
    datenews: new Date(),
    title:
      "Cyberbullying: práticas e consequências da violência virtual na escola",
    image: cyberbullimg,
...
const Materiais = () => {
  ...
  return (
    <div
      id="materiais"
      style={{ backgroundImage: `url(${light ? material : blackMaterial})` }}
    >
            ...
            {data.map((data, index) => (
              <Grid item xs={12} sm={6} md={4}>
                ...
                >
                  ...
                  <CardActions>
                    <Button size="medium" href={data.href}>
                      Ver
                    </Button>
                  </CardActions>
                </Card>
